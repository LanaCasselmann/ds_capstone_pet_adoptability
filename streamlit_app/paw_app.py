...
#st.write(os.getcwd())
ppp = Image.open('./streamlit_app/ppp.jpg')
st.image(ppp)
...
loaded_model = pickle.load(open('./streamlit_app/model.sav', 'rb'))
loaded_scaler = pickle.load(open('./streamlit_app/scaler.sav', 'rb'))
